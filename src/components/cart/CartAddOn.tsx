...
const CartAddOn: React.FC<AddonItemsProps> = ({
  selectedflavors,
  setSelectedflavors,
  selectedItems,
  setSelectedItems,
  ...
  return (
    <div className="w-full relative z-0">
      <div
        className={` bg-white border border-slate-200 p-2 rounded-lg shadow-xl transition-all duration-300 ease-out `}
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 border border-gray-100">
            ...
            <div className="space-y-3">
              {addonItems.map((item: IAddon) => (
                <div
                  key={item?.name}
                  className="flex items-center justify-between lg:p-3 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center gap-4">
                    ...
                    {/* Item name and price */}
                    <div>
                      <h4 className="font-medium lg:text-lg text-sm text-gray-800">
                        {item?.name}
                      </h4>
                      <p className="text-amber-600 lg:text-normal text-sm font-medium">
